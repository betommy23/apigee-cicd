...
current_deployment_info=$(curl -H "Authorization: Basic $base64encoded" "https://api.enterprise.apigee.com/v1/organizations/chishiuanlu-b72dd68a-eval/apis/HR-API/deployments")
